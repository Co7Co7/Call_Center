...
## 👤 Sobre el autor
Background: análisis de datos y economía. Proyecto de portafolio para mostrar
capacidades de EDA, ingeniería de código y comunicación visual de resultados.

## 📝 Notas para Claude
- Las explicaciones técnicas pueden asumir conocimiento de pandas, estadística y econometría básica
- Los ejemplos análogos en deportes o anime son bienvenidos cuando ayuden a clarificar
- Respuestas concisas, sin sobre-explicar lo obvio
- Si una decisión tiene trade-offs, mencionarlos brevemente antes de recomendar
